...
from app.app.models.models import Role as RoleModel, RoleCreate, RoleUpdate, Log as LogModel
import os
...
class RoleService:
    ...
    async def update_role(self, role_id: int, role: RoleUpdate) -> RoleModel:
    ...
    async def create_role_event(self, event: str, user_id: int, event_description: Optional[str] = None) -> LogModel:
