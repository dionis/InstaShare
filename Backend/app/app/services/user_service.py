...
from app.app.models.models import User as UserModel, UserCreate, UserUpdate, Document as DocumentModel, UserRole
import os
...
class UserService:
    ...
    async def list_users(self, offset: int = 0, limit: int = 100) -> List[UserModel]:
    ...
    async def get_documents_uploaded_by_user(self, user_id: int) -> dict:
